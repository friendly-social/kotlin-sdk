...
public class FriendlyClient(
    ...
    public val email: FriendlyEmailClient = FriendlyEmailClient(
        endpoint = endpoint,
        httpClient = this.httpClient,
    )
    ...
    public val activity: FriendlyActivityClient = FriendlyActivityClient(
        endpoint = endpoint,
        httpClient = this.httpClient,
    )

    public val notifications: FriendlyNotificationsClient =
        FriendlyNotificationsClient(
            endpoint = endpoint,
            httpClient = this.httpClient,
        )
    ...
    public companion object {
        ...
        public fun production(
            ...
            val endpoint = FriendlyEndpoint.production()
            return FriendlyClient(endpoint, httpClient)
        }
    }
}
